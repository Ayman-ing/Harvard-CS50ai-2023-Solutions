...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        #adding the safes and mines sentences
        add_to_knowledge=[]
        safe_cells=set()
        mine_cells=set()
        for sentence in self.knowledge:
            ...
            for sen in self.knowledge:
                if sen!=sentence  and sen.cells.issubset(sentence.cells):
                    sen_cells=sentence.cells - sen.cells
                    sen_count=sentence.count - sen.count
                    add_to_knowledge+=[Sentence(sen_cells,sen_count)]

          
        for cell in safe_cells:
            self.mark_safe(cell)
           
            #add_to_knowledge+=[Sentence(set((cell,cell)),0)]
        for cell in mine_cells:
            self.mark_mine(cell)
            
            #add_to_knowledge+=[Sentence(set((cell,cell)),1)]
        self.knowledge+=list(set(add_to_knowledge))
